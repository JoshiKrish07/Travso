...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2024 at 07:11 AM
...
CREATE TABLE `notifications` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `type` enum('like','comment','mention','message') NOT NULL,
...
INSERT INTO `users` (`id`, `full_name`, `gender`, `dob`, `city_id`, `email`, `mobile_no`, `otp`, `isOtpVerified`, `is_influencer`, `username`, `description`, `password`, `profile_image`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'John Doe', 'male', '1990-01-01', 1, 'johndoe@example.com', '1234567890', '123456', 1, 0, 'johndoe', 'Sample description', 'hashed_password', 'profile.jpg', 1, '2024-11-25 05:51:59', '2024-11-25 05:51:59'),
(2, 'Jane Smith', 'female', '1995-05-20', 2, 'janesmith@example.com', '9876543210', '654321', 1, 1, 'janesmith', 'Travel enthusiast', 'hashed_password_1', 'https://example.com/images/jane.jpg', 1, '2024-11-25 05:55:44', '2024-11-25 05:55:44'),
(3, 'Chris Johnson', 'male', '1988-08-08', 4, 'chrisjohnson@example.com', '3216549870', '112233', 1, 1, 'chrisjohnson', 'Tech enthusiast', 'hashed_password_3', 'https://example.com/images/chris.jpg', 1, '2024-11-25 05:56:19', '2024-11-25 05:56:19');
...
--
ALTER TABLE `buddies`
  ADD CONSTRAINT `buddies_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `media_links`
  ADD CONSTRAINT `media_links_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `posts`
  ...
  ADD CONSTRAINT `posts_ibfk_2` FOREIGN KEY (`location_id`) REFERENCES `cities` (`id`);
